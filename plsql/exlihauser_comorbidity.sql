/*
 ...
 Valid for MIMIC II database schema version 2.6 This scripts
 calculates elixhauser comorbidity scores from ICD9 and DRG
 codes. Code developed and provided by JoonWu Lee (joonlee@mit.edu).

 Citation:
 http://www.jstor.org/pss/3766985
 Comorbidity measures for use with administrative data
 A Elixhauser, C Steiner, DR Harris… - Medical Care, 1998 - JSTOR
