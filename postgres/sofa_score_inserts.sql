...
--select * from mimic2v25.chartevents where itemid = 20004 order by subject_id, charttime;--103684
...
-- Compare with mimic2v25
select 'V2.5 - ' || itemid, count(*) from mimic2v25.chartevents where itemid >= 20002 GROUP BY itemid 
union
